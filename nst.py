...
class Stylo_on_VGG:
    ...
    def to_user(self, tensor, title=None):
    ...
    def get_input_optimizer(self, input_img):
        ...
        optimizer = optim.LBFGS([input_img.requires_grad_()])  # евристика. с этим опт лучше (написан на фортране)
        return optimizer
    ...
    def get_style_model_and_losses(self, cnn, normalization_mean, normalization_std,
        ...
        # выбрасываем все уровни после последенего styel loss или content loss, птмч нам не нужно то что выдает сеть/посл слой с классификатором
